...
export default function Dashboard() {
  ...
  useEffect(() => {
    setCurrentPage(1)
  }, [searchQuery, selectedTag, sortBy, sortOrder, filters])
    ...
    <div className="p-2">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600">{totalPapers}件の論文が登録されています</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    type="number"
                    placeholder="開始年"
                    className="flex-1 px-3 py-2 bg-white border border-gray-200 rounded-md text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="著者名で検索"
                  className="w-full px-3 py-2 bg-white border border-gray-200 rounded-md text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
